...
public class MSColorTable : ColorTable
{
    ...
    public override System.Drawing.Color BackgroundTopGradient
    {
        get
        {
            return Color.FromArgb(54, 57, 64);
        }
    }
...
public class iTalk_ThemeContainer : ContainerControl
{
        ...
        : base()
    {
        ...
        BackColor = Color.FromArgb(54, 57, 64);
        DoubleBuffered = true;
    }
    ...
    protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
    {
        ...
        G.FillPath(new SolidBrush(Color.FromArgb(54, 57, 64)), RoundRectangle.RoundRect(new Rectangle(2, 20, Width - 5, Height - 42), BorderCurve));
...
class iTalk_CheckBox : Control
{
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        var _G = e.Graphics;
        _G.Clear(Color.FromArgb(54, 57, 64));
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        for (int TabIndex = 0; TabIndex <= TabCount - 1; TabIndex++)
        {
            if (TabIndex == SelectedIndex)
            {
                ...
                _Graphics.FillRectangle(new SolidBrush(Color.FromArgb(21, 101, 192)), TabHighlighter);
                // Draw tab text
...
class iTalk_Icon_Info : Control
{
    public iTalk_Icon_Info()
    {
        ...
        this.BackColor = Color.FromArgb(54, 57, 64);
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        e.Graphics.FillEllipse(new SolidBrush(Color.FromArgb(54, 57, 64)), new Rectangle(3, 3, 25, 25));
